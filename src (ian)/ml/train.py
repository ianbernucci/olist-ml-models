...
# Base Out Of Time
df_oot = df[df['data_referencia']=='2018-01-01']

# Base de Treino
df_train = df[df['data_referencia']!='2018-01-01']
...
var_identity = ['data_referencia','idVendedor']
target = 'flChurn'
to_remove = ['qtd_recencia', target] + var_identity
...
missing_minus_100 = ['media_intervalo_vendas',
                     'max_nota',
                     'mediana_nota',
                     'min_nota',
                     'media_nota',
...
mlflow.set_experiment("/Users/ianbernucci@gmail.com/olist-churn-ian")
